  ...
  useEffect(() => {
    const fetchWeatherData = async () => {
      ...
      try {
        ...
        const response = await fetch('https://api.openweathermap.org/data/2.5/forecast/daily?lat=44.18339&lon=-81.63307&cnt=7&appid=acf18add5a12d3c71802ca9d98bf29d3');
        if (!response.ok) {
